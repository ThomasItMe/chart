package com.company.chartexample.web.screens.screenframent;
...
@UiController("chartexample_ProductFragment")
@UiDescriptor("product-fragment.xml")
public class ProductFragment extends ScreenFragment {
    @Inject
